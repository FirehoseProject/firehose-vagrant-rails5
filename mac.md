...
Download and unzip the following file: [vagrant.zip](tools/vagrant.zip) to your __Desktop__. Unzip the file, it will create a folder called `vagrant` on your Desktop.  This is where all your web development environment will live.
